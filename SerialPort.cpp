...
UINT CSerialPort::CommThread(LPVOID pParam)
{
	...
	//Initialize comstat
	comstat.fCtsHold = FALSE;
	comstat.fDsrHold = FALSE;
...
void CSerialPort::SetDTR (bool DTR)
{
	
	if(DTR)
	{
		m_dcb.fDtrControl = DTR_CONTROL_ENABLE;		// set RTS bit high! 低电平
		//BuildCommDCB(szBaud, &m_dcb);
		SetCommState(m_hComm, &m_dcb);			
	}
	else
	{
		m_dcb.fDtrControl = DTR_CONTROL_DISABLE ;		// set RTS bit high!	高电平
		//BuildCommDCB(szBaud, &m_dcb);
		SetCommState(m_hComm, &m_dcb);
	}			
